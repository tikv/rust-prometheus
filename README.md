...
The crate has a pre-generated protobuf binding file for `protobuf` v1.7, if you need use the latest version of `protobuf`, you can generate the binding file on building with the `gen` feature after you [download](https://github.com/google/protobuf) and install the protocol buffer compiler.
